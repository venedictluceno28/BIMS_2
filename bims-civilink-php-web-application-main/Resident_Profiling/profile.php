...
$largestNumber = isset($_GET['res_id']) ? $_GET['res_id'] : null;
$rid = $largestNumber + 1;
header("Location: profile-final.php?id=" . $largestNumber);
exit;
          ...
          <div class="panel-body">
            ...
            <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <div class="col-sm-7">
                  <?php
                    // Ensure all address variables are initialized to avoid undefined variable warnings
                    $db_res_unit = isset($db_res_unit) ? $db_res_unit : '';
                    $db_res_build = isset($db_res_build) ? $db_res_build : '';
                    $db_res_lot = isset($db_res_lot) ? $db_res_lot : '';
                    $db_res_block = isset($db_res_block) ? $db_res_block : '';
                    $db_res_phase = isset($db_res_phase) ? $db_res_phase : '';
                    $db_res_house = isset($db_res_house) ? $db_res_house : '';
                    $db_res_street = isset($db_res_street) ? $db_res_street : '';
                    $db_res_sub = isset($db_res_sub) ? $db_res_sub : '';
                    $db_res_pur = isset($db_res_pur) ? $db_res_pur : '';
                    echo "{$db_res_unit}, {$db_res_build}, L{$db_res_lot}, BLK{$db_res_block}, PH{$db_res_phase}, {$db_res_house}, {$db_res_street} Street, {$db_res_sub}, {$db_res_pur}, Indang, Cavite";
                  ?>
                </div>
