   ...
   <div class="container">
      <div class="jumbotron">
         <div class="address-bar">
            <h1>
               <font >SMS NOTIFICATIONS</font>
            </h1>
            <h3>
               <font >Let you see our important SMS</font>
            </h3>
            <?php if (isset($_SESSION['position2']) && $_SESSION['position2'] == 'Barangay Admin' || $_SESSION['position'] == 'Barangay Captain') { ?>
         ...
         <?php
         $position = $_SESSION['position'];
         if ($_SESSION['position'] == 'Barangay Secretary' || $_SESSION['position'] == 'Barangay Captain' || $_SESSION['position'] == 'Barangay Treasurer') {
                  ...
                  <div class="box col-sm-12">
                     ...
                     <div class="col-sm-8">
                        ...
                        <p><span class="glyphicon glyphicon-time"></span>
                           <?php echo date("M jS, Y", strtotime($row['date'])) . ' (' . $row['receiver'] . ')'; ?></p>
