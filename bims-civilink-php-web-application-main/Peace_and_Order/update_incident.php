                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="blotter_type">
                                            <option value="1" <?php echo $blotterType == 1 ? "select" : "" ?>>Complaint
                                            </option>
                                            <option value="2" <?php echo $blotterType == 2 ? "select" : "" ?>>Incident
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-9 col-sm-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="hidden" name="residentId" value="<?php echo $compid ?>">
                                        <input type="hidden" name="residentIdOffender" value="<?php echo $offid ?>">

                                        <!-- 2 = outsider (default) -->
                                        <!-- 1 = resident of barangay -->
                                        <input type="hidden" name="complainantType"
                                            value="<?php echo $complainantType ?>">
                                        <input type="hidden" name="complainantTypeOffender"
                                            value="<?php echo $off_complainantType ?>">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $phone_number ?>" class="form-control"
                                            name="contact_number" id="contactNumber">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Birthday</label>
                                        <input type="text" value="<?php echo $birth_date ?>" class="form-control"
                                ...
                                <div class="col-md-9 col-sm-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" value="<?php echo $offender_name ?>" class="form-control"
                                            name="offender_name" id="">
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" value="<?php echo $offender_address ?>" class="form-control"
                                            name="offender_address" id="">
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea style="height:150px!important;" class="form-control"
                                            name="offender_description" id=""><?php echo $description ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-7 col-sm-12">
                                    <div class="form-group">
                                        <label>Case</label>
                                        <div class="">
                                            <label class="radio-inline"><input <?php echo $incident_type === 'criminal' ? 'checked' : '' ?> type="radio"
                                                    value="criminal"
                                                    name="optradio">&nbsp;Criminal&nbsp;&nbsp;&nbsp;</label>
                                            <label class="radio-inline"><input <?php echo $incident_type === 'civil' ? 'checked' : '' ?> type="radio" value="civil"
                                                    name="optradio">&nbsp;Civil&nbsp;&nbsp;&nbsp;</label>
                                            <label class="radio-inline"><input <?php echo $incident_type !== 'civil' && $incident_type !== 'criminal' ? 'checked' : '' ?> type="radio"
                                                    name="optradio" id="other_case"
                                                    value="other">&nbsp;Others&nbsp;&nbsp;&nbsp;</label>
                                            <input type="text" class="form-control" name="case" id="case_input"
                                                style="<?php echo $incident_type !== 'civil' && $incident_type !== 'criminal' ? 'display:block' : 'display:none'; ?>"
                                                value="<?php echo $incident_type ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-10 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $incident_title ?>"
                                            name="incident_title" id="">
                                    </div>
                                </div>
                                <div class="col-md-2 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="1" <?php echo $status === '1' ? "selected" : ""; ?>>Mediated 4a
                                            </option>
                                            <option value="2" <?php echo $status === '2' ? "selected" : ""; ?>>Concialited 4b
                                            </option>
                                            <option value="3" <?php echo $status === '3' ? "selected" : ""; ?>>Arbitrated 4a
                                            </option>
                                            <option value="4" <?php echo $status === '4' ? "selected" : ""; ?>>Arbitrated 4b
                                            </option>
                                            <option value="5" <?php echo $status === '5' ? "selected" : ""; ?>>Dismiss 4c
                                            </option>
                                            <option value="6" <?php echo $status === '6' ? "selected" : ""; ?>>Certified case
                                                4d</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $date ?>" class="form-control" name="date"
                                            id="incidentDate">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $time ?>" class="form-control" name="time"
                                            id="incidentTime">
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $location ?>" class="form-control"
                                            name="incident_location" id="">
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea style="height:250px!important;" class="form-control" name="narrative"
                                            id=""><?php echo $narrative ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer clearfix">
                            <button type="submit" name="save" data-id="<?php echo $_GET['edit'] ?>"
                                class="btn btn-primary float-right" value="update">Save</button>
