...
<div class="ccon1">
    <div class="secreta">
        <span id="name-input">
            <?php 
                echo (!empty($sfName) && !empty($smInitial) && !empty($slName)) 
                    ? $sfName . " " . $smInitial . ". " . $slName 
                    : "No Official";
            ?>
        </span><br>
        &emsp;SECRETARY
...
<div class="ccon">
    <div class="puno2">
        <span id="name-input">
            <?php 
                echo (!empty($capfName) && !empty($capmInitial) && !empty($caplName)) 
                    ? $capfName . " " . $capmInitial . ". " . $caplName 
                    : "No Official";
            ?>
        </span><br>
