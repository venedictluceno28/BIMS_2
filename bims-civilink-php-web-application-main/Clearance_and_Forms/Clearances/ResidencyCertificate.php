...
<?php
$capfName = isset($capfName) ? $capfName : '';
$capmInitial = isset($capmInitial) ? $capmInitial : '';
$caplName = isset($caplName) ? $caplName : '';
  $ctcNo = $_GET['crc'];
  $orNo = $_GET['or'];
  $res_ID = $_GET['res_ID'];
$sqlget_info = "SELECT *, resident_detail.RES_DATE_RECORD FROM resident_detail
...
if($resultCheck_info > 0){
    while($row = mysqli_fetch_assoc($result_info)){
        ...
        // Calculate duration
        $res_date_record = new DateTime($row['RES_DATE_RECORD']);
        $current_date = new DateTime(); // Current date and time
        $duration = $res_date_record->diff($current_date);

        // Prepare the duration string
        if ($duration->y > 0) {
            $durationString = $duration->y . " years";
        } elseif ($duration->m > 0) {
            $durationString = $duration->m . " months";
        } else {
            $durationString = $duration->d . " days";
        }
    }
}
...
<?php
  ...
  $sql14 = "SELECT * FROM finance_clearance_set;";
...
<!--end control #-->
<?php
// Set default values for $first, $lastName, and $middleName if not already set
$first = isset($first) ? $first : '';
$lastName = isset($lastName) ? $lastName : '';
$middleName = isset($middleName) ? $middleName : '';

// Query to get the resident ID based on first, last, and middle name
...
if($resultcheckNow > 0) {
  ...
  echo "Not a resident in this Barangay!";
  exit; // Stop further execution if no resident found
}
...
// Insert the form release data if $res_IDnow is set
if (isset($res_IDnow)) {
  $sqlsli = "INSERT INTO form_release (res_ID, form_ID, purpose_ID, release_date) VALUES ('$res_IDnow', 1, 1, '$datedate');";
  mysqli_query($db, $sqlsli);
} else {
  echo "Failed to insert due to missing resident ID.";
}
?>
    ...
    <div id="main-container">
      ...
      CERTIFICATE OF RESIDENCY
        ...
        <div class="c-wrapper ">
          ...
          <div class="names">
    <br>
    <span id="name-input"><?php echo isset($capfName) ? $capfName : "No Official"; ?> 
        <?php echo isset($capmInitial) ? $capmInitial . "." : ""; ?> 
        <?php echo isset($caplName) ? $caplName : ""; ?></span><br>
</div>
<div class="posi">
    Punong Barangay
</div>
<br>
<div class="names">
    <span id="name-input"><?php echo isset($pNcfName) ? $pNcfName : "No Official"; ?> 
        <?php echo isset($pNcmInitial) ? $pNcmInitial . "." : ""; ?> 
        <?php echo isset($pNclName) ? $pNclName : ""; ?></span><br>
</div>
<div class="posi">
    Peace and Order<br>
</div>
<br>
<div class="names">
    <span id="name-input"><?php echo isset($wfyfName) ? $wfyfName : "No Official"; ?> 
        <?php echo isset($wfymInitial) ? $wfymInitial . "." : ""; ?> 
        <?php echo isset($wfylName) ? $wfylName : ""; ?></span><br>
</div>
<div class="posi">
...
<br>
<div class="names">
    <span id="name-input"><?php echo isset($heafName) ? $heafName : "No Official"; ?> 
        <?php echo isset($heamInitial) ? $heamInitial . "." : ""; ?> 
        <?php echo isset($healName) ? $healName : ""; ?></span><br>
</div>
<div class="posi">
...
<br>
<div class="names">
    <span id="name-input"><?php echo isset($agrifName) ? $agrifName : "No Official"; ?> 
        <?php echo isset($agrimInitial) ? $agrimInitial . "." : ""; ?> 
        <?php echo isset($agrilName) ? $agrilName : ""; ?></span><br>
</div>
<div class="posi">
...
<br>
<div class="names">
    <span id="name-input"><?php echo isset($aprofName) ? $aprofName : "No Official"; ?> 
        <?php echo isset($apromInitial) ? $apromInitial . "." : ""; ?> 
        <?php echo isset($aprolName) ? $aprolName : ""; ?></span><br>
</div>
<div class="posi">
    Appropriation<br>
</div>
<br>
<div class="names">
    <span id="name-input"><?php echo isset($infrafName) ? $infrafName : "No Official"; ?> 
        <?php echo isset($inframInitial) ? $inframInitial . "." : ""; ?> 
        <?php echo isset($infralName) ? $infralName : ""; ?></span><br>
</div>
<div class="posi">
    Infrastructure<br>
</div>
<br>
<span id="name-input"><?php echo isset($secfName) ? $secfName : "No Official"; ?> 
    <?php echo isset($secmInitial) ? $secmInitial . "." : ""; ?> 
    <?php echo isset($seclName) ? $seclName : ""; ?></span><br>
<div class="posi">
    Secretary<br>
</div>
<br>
<div class="names">
    <span id="name-input"><?php echo isset($tresfName) ? $tresfName : "No Official"; ?> 
        <?php echo isset($tresmInitial) ? $tresmInitial . "." : ""; ?> 
        <?php echo isset($treslName) ? $treslName : ""; ?></span><br>
</div>
<div class="posi">
    Treasurer
</div>
          ...
          <div class="content">
            <div class = "ctrl">
              Control #: <?php echo $ctrlout;?>
            </div>
            <div id="par">

            <br><br>To whom it may concern:<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that Mr. / Mrs. 
<span id="name-input"><?php echo $first." ".$middleName." ".$lastName; ?></span>, of legal age, 
<span id="name-input"><?php echo $civilStatus; ?></span>, is a bona fide resident of Barangay 
<span id="name-input"><?php echo $head_brgy_Name." ".$citymun_disp.", ".$province_disp; ?></span>.<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;This certification further verifies that he/she has resided at the above-mentioned address for the past 
<span id="name-input"><?php echo $durationString; ?></span>.<br><br>


&nbsp;&nbsp;&nbsp;&nbsp;This certificate is issued upon the request of the aforementioned person for any legal purposes or intents 
that may serve him/her best.<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;Issued this <span id="name-input"><?php echo $datedate; ?></span> at 
