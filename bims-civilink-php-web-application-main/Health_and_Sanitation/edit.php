				...
				if (isset($_POST['new']) && $_POST['new'] == 1) {
					...
					<div>
						<form name="form" method="post" action="">
							...
							Drug name
							<p><input type="text" name="name" placeholder="Enter here..." required
									value="<?php echo $row['drug_Name']; ?>" /></p>
							Quantity
							<p><input type="text" name="quantity" placeholder="Enter here..." required
									value="<?php echo $row['drug_Qnty']; ?>" /></p>
							Description
							<p><input type="text" name="description" placeholder="Enter here.." required
									value="<?php echo $row['drug_Description']; ?>" /></p>
