...
<body>
	<?php require_once('sidebar.php'); ?>
						...
						<?php
						if (isset($_SESSION['position']) && $_SESSION['position'] != 'Resident') { ?>
							<br>
								...
								<p>
									...
									<datalist id="datalist1">
										...
										while($row = mysqli_fetch_assoc($result)) { ?>
											<optgroup>
												<option><?php echo $row['drug_ID'] . " " . $row["drug_Name"]; ?></option>
											</optgroup>
										<?php $count++; }
										?>
									</datalist>
									...
									<datalist id="datalist">
										...
										while($row = mysqli_fetch_assoc($result)) { ?>
											<optgroup>
												<option><?php echo $row["res_ID"] . " " . $row["res_fName"] . " " . $row["res_mName"] . " " . $row["res_lName"]; ?></option>
											</optgroup>
										<?php $count++; }
										?>
									</datalist>
