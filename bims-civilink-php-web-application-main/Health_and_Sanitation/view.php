...
<tr>
	...
	<td align="center"><a style="text-decoration:none" href="edit.php?id=<?php echo $row["drug_ID"]; ?>">Edit</a></td>
	<td align="center"><a style="text-decoration:none" onclick="return deleletconfig()" href="delete.php?id=<?php echo $row["drug_ID"]; ?>">Delete</a></td>
	</tr>
<?php $count++; }
